...
from .models import Post, Profile, File, Block, Comment
...
class CommentAdmin(admin.TabularInline):
    ...
    def get_formset(self, request, obj=None, **kwargs):
        CommentAdmin.obj = obj
        return super(CommentAdmin, self).get_formset(request, obj, **kwargs)
...
class PostAdmin(admin.ModelAdmin):
    inlines = [FileAdmin, CommentAdmin]
